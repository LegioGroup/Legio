...
namespace LG {
  ...
  void ImGuiLayer::OnAttach()
  {
    ...
    // Keyboard mapping. ImGui will use those indices to peek into the io.KeysDown[] array. TEMPORARY USE LG KEYCODES
    ...
    bool result = ImGui_ImplOpenGL3_Init("#version 410");
    LG_ASSERT(result, "Could not initialize ImGui!");
  }
